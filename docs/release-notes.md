...
- Reprints the owner bootstrap command and deeplink on `balda start` while the relay is still unclaimed, then stops exposing them again after the first successful owner auth.
