...
PATTERN='TestCommandHandlerSubmitGoalTask_PublishesJetStreamCommandOnly|TestInboundWebhookReceiver_AcceptsAndPublishesCommand|TestInboundWebhookReceiver_SessionModePublishesSessionCommand|TestScheduledTaskSchedulerDispatchTask_PublishesCommandAndReschedules|TestSubmitWebhookTaskUsesStableTaskAndDistinctDedupeKeys'
